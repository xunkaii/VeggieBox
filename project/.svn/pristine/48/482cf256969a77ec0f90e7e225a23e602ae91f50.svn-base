...
public class A01_EmpController {
	...
	// http://localhost:5090/springweb/empList01.do
	@RequestMapping("empList01.do")
	public String empList(Emp sch, Model d) {
		
		// 서비스에서 받은 Dao에서 가져온 ArrayList 데이터
		// empList이름으로 view단에 넘겨주는 model명을 설정
	...
	// submit으로 form name="empno" value="수정|기존"
	// submit으로 form name="ename" value="수정|기존"
	// ..
	// ?empno=101&ename=@@@&job=대리
	// setEmpno(int empno)
