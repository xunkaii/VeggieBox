               ...
               <div class="col-12 col-lg-5">
                  <div class="single_product_desc">
                     ...
                     <div class="product-meta-data">
                        <div class="line"></div>
                        <!-- 물건 가격 -->
                        <p class="product-price" style="font-weight: bold;"><fmt:formatNumber value="${prdDetail.price}"/>원</p>
                        ...
                        <div
                           ...
                           <div class="ratings">
                              <i class="fa fa-star" aria-hidden="true" style = "font-size:17px; font-weight:bold;">  4.7(106)</i> 
                           </div>
                           <div class="review">
                              <a href="#" style = "margin-left:-320px;">판매자: ${prdDetail.id}</a>
                           </div>
                        </div>
                     ...
                     <form class="cart clearfix" method="post">
                        ...
                        <button type="button" name="addtocart" value="5"
                           class="btn amado-btn" onclick="addToCartAndNavigate(${prdDetail.product_num})">Add to Cart
                        </button>
                     </form>
