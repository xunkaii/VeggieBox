...
<head>
    ...
    <title>VGbox Admin 2 - Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">정보 조회</a>
                        <a class="collapse-item" href="cards.html">판매자 등록</a>
                        <a class="collapse-item" href="cards.html">멤버쉽 관리</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="utilities-color.html">이미지 등록 관리</a>
                        <a class="collapse-item" href="utilities-border.html">멤버쉽 상품 관리</a>
                    </div>
                </div>
            </li>
