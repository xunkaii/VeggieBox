...
public class A04_PreparedDao {
    ...
    public List<Employee> getEmpList(Map<String, String> sch) {
        ...
        try {
            ...
            System.out.println("DB2 관련 오류: " + e.getMessage());
        } catch (Exception e) {
    ...
    public List<JobHistory> getHistory(Map<String, String> sch) {
        ...
        try {
            ...
            System.out.println("DB2 예외: " + e.getMessage());
        } catch (Exception e) {
    ...
    public void insertEmp(Emp ins) {
        ...
        try {
            ...
            System.out.println("DB2 오류: " + e.getMessage());
            DB_Prj.rollback(con);
        } catch (Exception e) {
            System.out.println("일반 오류: " + e.getMessage());
        } finally {
    ...
    public void updateEmp(Emp upt) {
        String sql = "UPDATE EMP02 SET ENAME = ?, job = ?, sal = ?, hiredate = to_date(?,'YYYY/MM/DD'),"
        		+ "deptno = ? WHERE empno = ?";
        try {
            con = DB_Prj.con();
            con.setAutoCommit(false);
