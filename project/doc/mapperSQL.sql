...
SELECT * FROM MEMBERSHIP m ;
UPDATE MEMBERSHIP 
	SET mems_begin_date = '2018-09-09',
		MEMS_END_DATE = '2018-12-09'
...
ORDER BY p.FOR_SALE  DESC, MEMS_END_DATE desc;
SELECT * FROM MEMBER_INFORMATION mi ;

SELECT * FROM MEMBERSHIP m ;
--INSERT INTO MEMBERSHIP m VALUES ('')
SELECT * FROM PRODUCT p ;
INSERT INTO PRODUCT p values(1008,'kdh1234','코리안멜론',23000,'2023-07-01',1);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1008);
INSERT INTO PRODUCT p values(1009,'kdh1234','멜론',42000,'2023-07-01',1);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1009);
INSERT INTO PRODUCT p values(1010,'ysn1234','복숭아',25000,'2023-10-01',0);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1010);
INSERT INTO PRODUCT p values(1011,'ysn1234','황도',29000,'2023-10-01',0);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1011);
INSERT INTO PRODUCT p values(1012,'ysn1234','백도',29000,'2023-10-01',0);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1012);
INSERT INTO PRODUCT p values(1013,'kdh1234','바나나',12000,'2023-06-01',1);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1013);
INSERT INTO PRODUCT p values(1014,'kdh1234','키위',18900,'2023-09-01',0);
INSERT INTO MEMBERSHIP m (PRODUCT_NUM) VALUES (1014);
...
SELECT * FROM PRODUCT p ;
-- 판매자 선택 (select)
SELECT id FROM SELLER_REG_INFO;
/*
INSERT INTO PRODUCT VALUES (1015,'kdh1234','사과',8000,'2023-08-08',0);

INSERT INTO PRODUCT VALUES
	(#{product_num},#{id},#{product_name},#{price},#{reservation_period},#{for_sale})
	
INSERT INTO PRD_IMG VALUES
...
SELECT * FROM PRD_IMG;
INSERT INTO prd_img VALUES (1015,'melon.png','melon1.png','melon.png2','melon.png3');
SELECT * FROM PRD_IMG pi2 ;
INSERT INTO MEMBERSHIP (product_num) VALUES (1015);

ALTER TABLE PRODUCT DROP COLUMN reservation_period;
SELECT * FROM PRODUCT p ;